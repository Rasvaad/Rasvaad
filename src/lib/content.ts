...
export const heroStats = [
  ...
  { value: "Surat/Navsari", label: "Trusted Caterers" },
];
...
export const processSteps = [
  {
    ...
    text: "We understand your event requirements, guest count, and preferences to design the perfect catering plan.",
    hinglish: "Aapki need samajh kar perfect menu design karte hain.",
  },
  {
    title: "Fresh Preparation & Setup",
    text: "We use fresh ingredients and ensure elegant setup with timely execution.",
    hinglish: "Fresh food + beautiful setup + on-time delivery.",
  },
  {
    title: "Seamless Service Execution",
    text: "Our trained staff delivers smooth and professional service, ensuring your guests enjoy every moment without any hassle.",
    hinglish: "Aap enjoy karo, baaki sab hum handle karte hain.",
  },
];
...
export const blogPosts = [
  {
    title: "Best Wedding Catering Services in Surat – Complete Guide",
    hinglish: "Surat mein Best Caterer kaise choose kare",
  },
  {
    title: "Catering Cost in Surat & Navsari (2025 Price Guide)",
    hinglish: "Catering ka price Surat/Navsari mein kitna hota hai",
  },
  {
    title: "Top Catering Trends in Surat for Weddings & Events",
    hinglish: "Shaadi ke liye latest catering trends",
  },
];
